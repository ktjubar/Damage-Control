<form action="<?= BASE_URL ?>/articles/add/process/" method="POST">
  ...
  <div class="form-group row">
    ...
    <div class="col-9">
      <input class="form-control" type="text" name="subtitle" maxlength="255">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-3 col-form-label">
    ...
    <div class="col-9">
      <input class="form-control" type="date" name="relevdate">
    </div>
  </div>
  <div class="row mb-4">
    <div class="col-12">
      <h5>Article Body: </h5>
      <textarea id="articleBody" class="w-100" name="body" required></textarea>
    </div>
  </div>
  <div class="row">
    <div class="col-6">
